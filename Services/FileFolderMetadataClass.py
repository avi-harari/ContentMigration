...
class FileFolderMetadataClass:
    ...
    def __init__(self, Credentials, AsUser=''):
    ...
    def GetSyncpointID(self, Syncpoint_Name):
        All_Syncpoints = self.GetAllSyncpoints()
        for i in All_Syncpoints:
            if i['Name'] == Syncpoint_Name:
                return i['Id']
